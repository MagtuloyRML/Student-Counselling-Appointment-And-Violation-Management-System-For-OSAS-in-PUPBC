                ...
                <form id="addRole"  method = "POST">
                    <div class="input_group">
                        ...
                        <div class="input_container">
                            ...
                            <div class="input " id="input_roleName">
                                <input class="input-fieldcheck" type="checkbox" name="studCounce" id="studCounce">
                                <i id="i_roleName" ></i>
                            </div>
                        </div>
                        <div class="input_container">
                            ...
                            <div class="input " id="input_roleName">
                                <input class="input-fieldcheck" type="checkbox" name="studViolation" id="studViolation">
                                <i id="i_roleName" ></i>
                            </div>
                        </div>
                        <div class="input_container">
                            ...
                            <div class="input " id="input_roleName">
                                <input class="input-fieldcheck" type="checkbox" name="sysMain" id="sysMain">
                                <i id="i_roleName" ></i>
                            </div>
                        </div>
                    ...
                    <h3 class="list_title">Role List</h3>
                        <table class="display">
                            ...
                            <tr>
                                ...
                                <td class="data">
                                    <label id="label_studCounceData" for="studCounceData" class="labelcheckData"> 
                                        <i id="i_studCounceData" > </i>
                                    </label>
                                    <input class="input-fieldchecktable" type="checkbox" name="studCounceData" id="studCounceData" value= 'TRUE' 
                                    <?php if($studentCounc != '0' )echo "checked" ?> >
                                </td>
                                <td class="data">
                                    <label id="label_studViolationData" for="studViolationData" class="labelcheckData"> 
                                        <i id="i_studViolationData" > </i>
                                    </label>
                                    <input class="input-fieldchecktable" type="checkbox" name="studViolationData" id="studViolationData" value= 'TRUE'
                                    <?php if($studentViolation != '0' )echo "checked" ?>>
                                </td>
                                <td class="data">
                                    <label id="label_sysMainData" for="sysMainData" class="labelcheckData"> 
                                        <i id="i_sysMainData" > </i>
                                    </label>
                                    <input class="input-fieldchecktable" type="checkbox" name="sysMainData" id="sysMainData" value= 'TRUE'
                                    <?php if($sysMain != '0' )echo "checked" ?>>
                                </td>
                                <td class="data">
