                    ...
                    <div class="modal_studDetails_input_container">
                        ...
                        <div class="modal_studDetails_input">
                                ...
                                <select class="input_field" name="ayCode" id="ayCode">
                                    ...
                                    <option disabled selected> --Academic Year and Section-- </option>
                                    <?php
                                    $result2 = mysqli_query($conn, "SELECT * FROM foracademicyear");
                                    while ($row = mysqli_fetch_array($result2)){ ?>
                                        <option value="<?php echo $row['code']; ?>">
                                        <?php 
                                        $final = $row['yearFrom']. ' - ' .$row['yearTo']. ', '.$row['Semester'];
                                        echo $final; ?> 
                                        </option>
                                    <?php 
                                    }
